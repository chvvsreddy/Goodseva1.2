    ...
    <div className='layoutStyle'>
      <Row>
        <Col sm={6} xs={24}>
          ...
          <Link href="/"><img src="goodseva-logo.png" alt=" Goodseva logo" height={50}/></Link>
            <Typography style={{ fontSize: 16, width: 331, height: 78 }} >
        ...
        <Col sm={3} xs={0}></Col>
        <Col sm={15} xs={24} className="f-resources">
        <Row gutter={12}>
          <Col sm={8} xs={24}>
          <Title level={5} style={{ color: "#7F1126" }} id="footer-head-Title" >
                Company
              </Title>
          ...
          <Title level={5} style={{ color: "#7F1126" }} id="footer-head-Title" >
              ...
              <Typography style={{ fontSize: 16 }}>Faqs</Typography>
              <Typography style={{ fontSize: 16 }}>
                Pricing and Quotes
              </Typography>
              <Typography style={{ fontSize: 16 }}>
      ...
      <Row>
        ...
        <Divider variant="solid" style={{ borderColor: "black" }} />
          <Typography>Copyright &copy; 2024 Suvega</Typography>
        </Col>
      </Row>
    </div>
  </div>
